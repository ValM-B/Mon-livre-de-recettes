    ...
    <div class="container">
        ...
        <form method="post" action="">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="categoryName"  placeholder="Nom de l'utilisateur" name="name"  value='<?= $user->getName() ?>' >
                <label for="userEmail">email</label>
                <input type="email" class="form-control" id="userEmail"  placeholder="Email de l'utilisateur" name="email"  value='<?= $user->getEmail() ?>' >
                <label for="userPassword">Mot de passe</label>
                <input type="password" class="form-control" id="userPassword"  placeholder="Mot de passe de l'utilisateur" name="password"  value='<?= $user->getPassword() ?>' >
